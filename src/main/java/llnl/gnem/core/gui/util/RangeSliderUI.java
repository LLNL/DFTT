...
class RangeSliderUI extends BasicSliderUI {
     ...
     * @param width  The width of the new thumb..
     * @param height  The height of the new thumb.
     * @return   A Shape object used to render the thumb.
     */
     ...
     * lower thumb.
     * @param x  The x-location of the new location.
     * @param y  The y-location of the new location.
     */
