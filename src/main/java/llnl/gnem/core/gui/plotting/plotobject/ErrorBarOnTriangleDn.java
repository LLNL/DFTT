 ...
 */
public class ErrorBarOnTriangleDn extends ErrorBar {
     ...
     */
    public ErrorBarOnTriangleDn(double X, double Y, double size, double sigmaPlus, double sigmaMinus, double halfWidth, Color fillC,
     ...
     * @param fontsize  The fontsize of the associated text.
     */
    public ErrorBarOnTriangleDn(double X, double Y, double size, double sigma, double halfWidth, Color fillC, Color edgeC,
     ...
     * @param size       Size of the symbol in millimeters
     */
    public ErrorBarOnTriangleDn( double X, double Y, double size, double sigmaPlus, double sigmaMinus, double halfWidth )
    {
     ...
     * @param halfWidth The half-width of the error bar "I-Beam" in mm
     */
    public ErrorBarOnTriangleDn( double X, double Y, double size, double sigma, double halfWidth )
    {
        super( X, Y, size, sigma, halfWidth );

    }

    public ErrorBarOnTriangleDn() {
        super();
    }
    ...
    public String toString() {
        return "ErrorBarOnTriangleDown" + super.toString();
    }
}
