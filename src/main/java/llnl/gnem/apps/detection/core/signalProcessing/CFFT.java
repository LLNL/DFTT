...
public class CFFT extends FFT {

  

   public CFFT( int log2N ) {
      super( log2N );
   }
   
   
   
   public void dft( float[] x, float[] y ) {
   ...
   private void stage( int n2, int n4, int its, float[] x, float[] y ) {
  ...
  public void idft( float[] x, float[] y ) {
